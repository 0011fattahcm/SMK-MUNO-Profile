...
const struktur = [
  ...
  {
    nama: 'Anisa Eka Aprilia Dani, S.M',
          ...
          {struktur
            ...
            .map((item, index) => (
              ...
              >
                ...
                <p className="text-gray-700 font-semibold mb-4">{item.jabatan}</p>

                <p className="text-gray-800 text-sm text-justify leading-relaxed">
                  Eko Pamuji, S.T. saat ini menjabat sebagai Kepala Sekolah SMK Muhammadiyah
                  Sumowono sejak tahun 2018. Beliau lahir di Semarang pada tanggal 8 Oktober 1976
                  dan tinggal di Kampung Plalangan, Kecamatan Gunungpati, Kota Semarang.
                  <br />
                  <br />
                  Pendidikan dasar beliau dimulai dari SD Kanisius Lodoyong, dilanjutkan ke SMP
                  Pangudi Luhur Ambarawa dan STM Kristen Salatiga. Beliau kemudian menyelesaikan
                  pendidikan tinggi di Universitas Sanata Dharma Yogyakarta dan meraih gelar Sarjana
                  Teknik.
                  <br />
                  <br />
                  Pengabdian beliau di dunia pendidikan sudah dimulai sejak tahun 2001 di SMK
                  Muhammadiyah Ungaran, di mana beliau pernah menjabat sebagai kepala sekolah pada
                  tahun 2015 hingga 2018. Semangat dan dedikasinya untuk mencetak generasi yang
                  berakhlak, mandiri, dan berdaya saing tinggi terus beliau lanjutkan di SMK
                  Muhammadiyah Sumowono.
                  <br />
                  <br />
                  Sebagai seorang pendidik, beliau dikenal sebagai pribadi yang tegas namun ramah,
                  serta sangat peduli terhadap perkembangan karakter siswa dan kemajuan teknologi
                  dalam pembelajaran. Beliau meyakini bahwa pendidikan vokasi harus selaras dengan
                  kebutuhan zaman dan dunia kerja.
                </p>
              </div>
            ))}
        </div>
